...
public static class BlockHelper
{
        ...
        (ChunkData chunk, int x, int y, int z, MeshData meshData, BlockType blockType)
    {
        ...
        foreach (Direction direction in directions)
        {
            ...
            // First check makes sure that if the next block is in another chunk, we do not need to render that face.
            // Second check checks that if the neigbouring block is solid, we will no see that face, and not render it.
